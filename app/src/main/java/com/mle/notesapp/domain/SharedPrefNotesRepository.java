...
public class SharedPrefNotesRepository implements NotesRepository{
    ...
    public void getAll(Callback<List<Note>> callback) {
        ...
        // Сохранение заметки в строку
        String savedData = sharedPreferences.getString(KEY_SAVED_NOTES, "[]");

        // Преобразовываем строку в список заметок
    ...
    public void add(String title, String message, Callback<Note> callback) {
        ...
        String savedData = sharedPreferences.getString(KEY_SAVED_NOTES, "[]"); // Сохранение заметки в строку
        ...
        sharedPreferences.edit().putString(KEY_SAVED_NOTES, toWrite)
                .apply();
